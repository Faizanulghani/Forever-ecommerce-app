  ...
  return (
    <div class="border-t pt-16">
      ...
      <div>
        ...
        return  <div key={index} class="py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-start gap-6 text-sm">
              <img class="w-16 sm:w-20" src={item.image[0]} alt="" />
              <div>
                <p class="sm:text-base font-medium">
                  {item.name}
                </p>
                ...
                <p class="mt-1">
                  Date: <span class=" text-gray-400">Sat Jul 19 2025</span>
                </p>
                <p class="mt-1">
